...
double  Calculo_ERRO(double a,double b,double lambda, int n)
{
    ...
    ITMAX=28; // Número máximo de iteraçõees no método de Romberg para cálculo das integrais do nosso sistema.
    Precisao=0,0000001; // A precisão desejada no métdo de Romberg
